          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 py-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/auth/forgot-password" className="text-gray-400 hover:text-white">Forgot Password</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 pt-8 pb-6 mt-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-wrap gap-6 md:justify-end">
                <Link to="/admin" className="text-sm text-gray-400 hover:text-white">Admin Portal</Link>
              </div>
            </div>
          </div>
        </Container>
