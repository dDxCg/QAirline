...
const FlightCard: React.FC<FlightCardProps> = ({
  ...
  const [arrivalDate, arrivalTime] = flight.arrival_time.split(" - ");
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 lg:gap-4 mb-4 lg:mb-6">
          <div className="flex items-center">
            <span className="text-blue-600 font-semibold text-lg lg:text-xl">
              {flight.flight_uuid}
            </span>
            <span className="text-gray-500 ml-3 text-sm lg:text-base">
              {flight.aircraft}
            </span>
          </div>
        ...
        <div className="mt-6 pt-4 border-t border-gray-200 flex flex-wrap items-center justify-between gap-4">
          ...
          <Button
            ...
            onClick={() => onSelect(flight.flight_uuid)}
          >
            Select Flight
          </Button>
        </div>
