  ...
  const destinations = [
    {
      ...
      description:
        "Explore the rich history, iconic landmarks, and diverse culture of England's capital.",
    ...
    },
    {
      ...
      title: "City of Light",
      description:
        "Experience the romance, art, and exquisite cuisine of the French capital.",
    ...
    },
    {
      ...
      description:
        "Immerse yourself in the unique blend of tradition and cutting-edge technology in Japan.",
  ...
  const services = [
    {
      ...
      description:
        "Relax in exclusive lounges with complimentary drinks and Wi-Fi.",
      icon: (
    ...
    },
    {
      ...
      description:
        "Enjoy the latest movies, TV shows, and music on your personal screen.",
      icon: (
        <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-blue-500 flex items-center justify-center">
          <svg
            className="w-8 h-8 text-white"
    ...
    <Layout>
      ...
      <div className="min-h-screen bg-[url('/images/sky-bg.jpg')] bg-cover bg-fixed bg-center relative">
        ...
        <div className="relative">
          {/* Hero Section */}
          <section className="min-h-[80vh] sm:h-[70vh] flex items-center relative overflow-hidden py-8 sm:py-0">
                ...
                <div className="text-center">
                  ...
                  <div className="flex gap-3 sm:gap-4 justify-center mb-8 sm:mb-12">
                    <Button
                      ...
                      onClick={() => navigate("/flights?getAll=true")}
                    >
            ...
            <Container>
              <div className="backdrop-blur-md bg-white/30 rounded-3xl p-12 shadow-2xl border border-white/30">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <Card
                    variant="hover"
                    className="text-center backdrop-blur-md bg-white/30 border border-white/30"
                  >
                    ...
                    <p className="text-blue-800">
                      Our commitment to safety is unwavering, with the highest
                      industry standards and regular maintenance.
                    </p>
                  </Card>
                  ...
                  >
                    ...
                    <p className="text-blue-800">
                      We take pride in ensuring on-time performance, helping you
                      reach your destination as scheduled.
                    </p>
                  </Card>
                  ...
                  >
                    ...
                    <p className="text-blue-800">
                      Exceptional customer service and comfort make every
                      journey memorable.
                    </p>
                  </Card>
                </div>
