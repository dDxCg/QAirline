...
(
    ...
    CONSTRAINT tickets_pkey PRIMARY KEY (ticket_uuid),
...
(
    ...
    CONSTRAINT flights_pkey PRIMARY KEY (flight_uuid),
...
(
    id integer NOT NULL DEFAULT nextval('guest_bookings_id_seq'::regclass),
...
ALTER TABLE IF EXISTS public.passenger_info
    ADD CONSTRAINT fk_passenger_info_ticket_uuid FOREIGN KEY (ticket_uuid)
    REFERENCES public.tickets (ticket_uuid) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
